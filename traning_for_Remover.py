...
def parse(args=None):
    ...
    parser.add_argument('--lambda_em', type=float, default=0)
    parser.add_argument('--lambda_lp', type=float, default=0)
...
for epoch in range(0,args.epochs):
    ...
    if epoch %1==0 :
        CanFG.save('premodels/anonymized_'+str(args.lambda_rec)+'_id_'+str(args.lambda_id)+'_em_'+str(args.lambda_em)+'_lp_'+str(args.lambda_lp)+'.pt')
    ...
    if epoch%1==0:
        ...
        with torch.no_grad():
            ...
            for img_a in valid_dataloader:
                ...
                filename='test_images/'+'rec'+str(args.lambda_rec)+'_id_'+str(args.lambda_id)+'_em_'+str(args.lambda_em)+'_lp_'+str(args.lambda_lp)+'_'+ str(epoch) + '.jpg'
